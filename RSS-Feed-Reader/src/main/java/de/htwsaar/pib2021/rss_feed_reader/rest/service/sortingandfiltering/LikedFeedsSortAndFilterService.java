...
public class LikedFeedsSortAndFilterService {
    ...
    public LikedFeedsSortAndFilterService(ChannelUserRepository channelUserRepository,
            LikedFeedItemUserRepository likedFeedItemUserRepository, CustomPagination customPagination) {
        this.channelUserRepository = channelUserRepository;
        this.likedFeedItemUserRepository = likedFeedItemUserRepository;
