...
public interface LikedFeedItemUserRepository extends JpaRepository<FeedItemUser, FeedItemUserId> {
    ...
    Page<FeedItemUser> findByUserAndLikedOrderByFeedItem_PublishDateDesc(User user, Boolean readLater,
            Pageable pageable);

    Page<FeedItemUser> findByUserAndLikedOrderByFeedItem_PublishDateAsc(User user, Boolean readLater,
            Pageable pageable);
    ...
    List<FeedItemUser> findByUserAndLikedAndFeedItem_Channel(User user, Boolean readLater, Channel channel);
