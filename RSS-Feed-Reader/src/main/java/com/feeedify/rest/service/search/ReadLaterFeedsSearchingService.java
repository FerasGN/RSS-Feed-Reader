...
import com.feeedify.database.repository.ReadLaterFeedItemUserRepository;
    ...
    private List<FeedItemUser> findFilteredAndOrderedFeedItemsUser(String q, User user, LocalDate startDate,
        ...
        switch (order) {
            ...
            case ORDER_BY_ALL_CATEGORIES: {
                feedItemsUser = findFeedItemUsersByReadLaterOrderedByCategoryName(user, true, pageNumber,
                        feedItemsUser);
                break;
            } // end case
