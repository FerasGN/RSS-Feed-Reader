...
public class Constants {
    ...
    public final static String CONFIRMATION_MESSAGE = "To confirm your account by Feeedify, please click here: " + Endpoints.HOST_NAME + "confirm-account?confirmationToken=";
